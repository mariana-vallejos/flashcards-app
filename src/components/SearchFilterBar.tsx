  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-2 w-full px-9 pt-5">
      <select
        ...
        className="border px-4 py-2 rounded-md w-full md:w-1/5 focus:outline-none focus:ring-2 focus:ring-amber-400"
      >
      ...
      <input
        ...
        className="border px-4 py-2 rounded-md w-full md:w-1/4 focus:outline-none focus:ring-2 focus:ring-amber-400"
      />
